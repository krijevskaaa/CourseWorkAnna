...
int main() {
    Zoo zoo;
    int weight,age,satiety,wing_length,lactation_period,selection, length,capacity = 10;
        ...
        switch (selection)
        {
            ...
            case 3:
            {
                ...
                } else
                {
                    ...
                    Animal* a = zoo.Feeding(food_parameters);
                    if (a)
                    {
                        cout << Animal::getStringFromEnum(a->GetKind()) << " is fed\n";
                    } else {
            ...
            case 4:
            {
                ...
                switch (selection)
                {
                    case 1:
                    {
                        cout << "List of animals(max " << zoo.GetCapacity() << " animals):\n";
                        zoo.PrintZoo();
                        break;
                    }
                    case 2:
                    {
                        ...
                        int place;
                        cin >> place;
                        zoo.setCapacityIncrease(place);
                        cout << "Capacity became " << zoo.GetCapacity() << "\n";
                        break;
                    }
                    case 3:
                    {
                        cout << "How many places do you want to remove:";
                        int place;
                        cin >> place;
                        zoo.setCapacityReduce(place);
                        cout << "Capacity became " << zoo.GetCapacity() << "\n";
                        break;
                    }
                    default:
